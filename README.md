...
4. Use the [Metric Workshop](./Metric_Workshop.md) in the KPI case clinic — calculation cards, scenario matrix, and visual sequence.
...
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Engagement delivery                   | [Basware Embed — 2-Week Playbook](./Basware_Engagement_Playbook.md), [Metric Workshop](./Metric_Workshop.md)                                                                                                                                                                                         | Delivery sequence, case-clinic visuals, calculation templates, and decision artifacts.                                  |
